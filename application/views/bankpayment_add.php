                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="amount_hand" id="amount_hand" class="form-control" placeholder="Amount in hand" maxlength="9" value = "<?php echo set_value('amount_hand'); ?>" onkeypress="return numberValidate(event);">
                                </div>
                                <div class="form-group">
