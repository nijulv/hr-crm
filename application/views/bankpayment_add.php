                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="total_payment" id="total_payment" class="form-control" placeholder="Total Payment" value = "<?php echo set_value('total_payment'); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Bank payment <span class="required">*</span></label>
                                    <input type="text" name="bank_payment" id="bank_payment" class="form-control" placeholder="Bank Payment" value = "<?php echo set_value('bank_payment'); ?>" required>
                                </div>
                                <div class="form-group">
                                    <label>Reason <small class="text-muted"></small></label>
                                    <textarea class="form-control" name="reason" id="user" style="height: 150px !important;"><?php echo set_value('reason');?></textarea>
                                </div>
                                <div class="form-group">
