<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	    ...
	    <form class="form-label-left form-horizontal" enctype="multipart/form-data" method ="POST" action="<?php echo base_url() ?>edituser/<?php echo $user_details['user_id']?>" name="frmUserdetails" id="frmUserdetails">   
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12 " for="txtFirstname">First Name<span class="required">*</span>
                        </label>
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="firstname" id="firstname" value="<?php echo $user_details['first_name']?>" required>
                        </div>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="text" class="form-control col-md-7 col-xs-12" name="phonenumber" id="phonenumber" value="<?php echo $user_details['phone']?>" required>
                        </div>
                    </div>
                    <div class="form-group">
